...
{
    [Breadcrumb("Engineering", FromPage = typeof(Crew.IndexModel))]
    public class EngineeringModel : PageModel
    {
        ...
        {
            _logger.LogInformation($"University Seagoing Crew Engineering positions page visited at {DateTime.UtcNow.ToLongTimeString()}");
