    ...
    public class SeedDataHelper
    {
        ...
        private void Certificates()
        {
            ...
            _db.Certificates.AddRange(new List<Certificate>()
            {
                ...
                new Certificate { Id =  2, DescEng = "lorem ipsum", DescFre = "lorem ipsum", NameEng = "Master 1600A GT", NameFre = "Master 1600A GT", RequireIndicatorEng = "Master 1600A GT", RequireIndicatorFre = "Master 1600A GT" },
                new Certificate { Id =  3, DescEng = "lorem ipsum", DescFre = "lorem ipsum", NameEng = "Z Alpha MDX", NameFre = "Z Alpha MDX", RequireIndicatorEng = "Z Alpha MDX", RequireIndicatorFre = "Z Alpha MDX" },
                new Certificate { Id =  4, DescEng = "lorem ipsum", DescFre = "lorem ipsum", NameEng = "V Delta MKZ", NameFre = "V Delta MKZ", RequireIndicatorEng = "V Delta MKZ", RequireIndicatorFre = "V Delta MKZ" },
                new Certificate { Id =  5, DescEng = "lorem ipsum", DescFre = "lorem ipsum", NameEng = "six Sigma", NameFre = "six Sigma", RequireIndicatorEng = "six Sigma", RequireIndicatorFre = "six Sigma" },
                new Certificate { Id =  6, DescEng = "lorem ipsum", DescFre = "lorem ipsum", NameEng = "Marine Certificate", NameFre = "Certificat de navigation", RequireIndicatorEng = "Marine Certificate", RequireIndicatorFre = "Certificat de navigation" },
                new Certificate { Id =  7, DescEng = "lorem ipsum", DescFre = "lorem ipsum", NameEng = "CCG Logistics Officer Certificate", NameFre = "Certificat d'officier de logistique de la GCC", RequireIndicatorEng = "CCG Logistics Officer Certificate", RequireIndicatorFre = "Certificat d'officier de logistique de la GCC" },
                new Certificate { Id =  8, DescEng = "lorem ipsum", DescFre = "lorem ipsum", NameEng = "Auditor Training Program", NameFre = "Programme de formation d'auditeur", RequireIndicatorEng = "Auditor Training Program", RequireIndicatorFre = "Programme de formation d'auditeur" },
                new Certificate { Id =  9, DescEng = "lorem ipsum", DescFre = "lorem ipsum", NameEng = "Safety Management for Industrial Facilities Certificate", NameFre = "Certificat en gestion de la sécurité des installations industrielles", RequireIndicatorEng = "Safety Management for Industrial Facilities Certificate", RequireIndicatorFre = "Certificat en gestion de la sécurité des installations industrielles" },
