    ...
    public partial class SeedDataHelper
    {
        public List<CompetencyLevelRequirement> CompetencyLevelRequirements = new List<CompetencyLevelRequirement>()
        {
            ...
            new CompetencyLevelRequirement
            {
                ...
                DescFre = "Traite des questions standard de gestion des effectifs dans les domaines de responsabilité. Supervise ou gère le personnel (opérationnel ou administratif). Fournit un compte rendu des performances. Aligne les pratiques de gestion des effectifs sur les résultats et les conclusions des audits, le cas échéant. Fournit une formation sur le lieu de travail et formule des recommandations en matière de formation et de développement. Participe à des commissions de dotation en personnel et contribue à l'énoncé des critères de mérite, le cas échéant."
            },
            new CompetencyLevelRequirement
            {
                Id = 90,
            ...
            {
                Id = 163,
                DescEng = "Understands basic traffic patterns for traffic avoidance, observing and reporting weather conditions, and local tides in immediate surroundings.",
            ...
            {
                Id = 164,
                DescEng = "Practical knowledge of a range of coastal domain factors including local weather predictability, vessel traffic avoidance in a given charted area, and local tides and currents.",
