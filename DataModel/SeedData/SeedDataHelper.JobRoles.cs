...
namespace DataModel.SeedData
{
    public partial class SeedDataHelper
    {
        public List<JobRole> JobRoles = new List<JobRole>()
        {
            ...
            new JobRole() {JobGroupId = 18, SubJobGroupId = 25, JobGroupLevelId = 3},
            new JobRole() {JobGroupId = 18, SubJobGroupId = 25, JobGroupLevelId = 4},
            new JobRole() {JobGroupId = 18, SubJobGroupId = 25, JobGroupLevelId = 5},
