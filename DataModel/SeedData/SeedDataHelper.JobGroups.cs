...
namespace DataModel.SeedData
{
    public partial class SeedDataHelper
    {
        public List<JobGroup> JobGroups = new List<JobGroup>()
        {
            ...
            new JobGroup {Id = 8, Code = "GL", NameEng = "General Labour and Trades", NameFre = "Manœuvres et hommes de métier"},
            new JobGroup {Id = 9, Code = "SC", NameEng = "Ships' Crews", NameFre = "Équipages de navires"},
            new JobGroup {Id = 10, Code = "SO", NameEng = "Ships' Officers", NameFre = "Officiers et officières de navire"},
