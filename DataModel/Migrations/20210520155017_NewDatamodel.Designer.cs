...
namespace DataModel.Migrations
{
    ...
    [Migration("20210520155017_NewDatamodel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataModel.JobGroupPositionSearchPercentage", b =>
                {
                    b.Property<int>("JobGroupPositionId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("JobGroupPositionId", "JobGroupId", "SubJobGroupId", "JobGroupLevelId", "JobPositionId", "SearchPercentageId");
                    ...
                    b.ToTable("JobGroupPositionSearchPercentages");
                });
            ...
            modelBuilder.Entity("DataModel.JobRolePositionCertificate", b =>
                {
                    ...
                    b.HasKey("JobGroupId", "JobGroupLevelId", "JobPositionId", "CertificateId", "CertificateDescriptionId");
            ...
            modelBuilder.Entity("DataModel.JobRolePositionCompetencyRating", b =>
                {
                    ...
                    b.HasKey("JobGroupId", "JobGroupLevelId", "JobPositionId", "CompetencyId", "CompetencyTypeId", "CompetencyRatingLevelId", "CompetencyLevelRequirementId");
            ...
            modelBuilder.Entity("DataModel.JobGroupPositionSearchPercentage", b =>
                {
                    ...
                    b.HasOne("DataModel.JobGroupPosition", "JobGroupPosition")
                        .WithMany()
                        .HasForeignKey("JobGroupPositionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
