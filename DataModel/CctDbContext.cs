    ...
    public class CctDbContext : DbContext
    {
        ...
        private void SeedData(ModelBuilder builder)
        {
            ...
            builder.Entity<JobRolePositionCompetencyRating>().HasData(
                            ...
                            new JobRolePositionCompetencyRating() { JobGroupId = 1, JobGroupLevelId = 3, JobPositionId = 1, CompetencyId = 1, CompetencyTypeId = 1, CompetencyRatingLevelId = 1, CompetencyLevelReqId = 1 },
                            new JobRolePositionCompetencyRating() { JobGroupId = 1, JobGroupLevelId = 3, JobPositionId = 1, CompetencyId = 2, CompetencyTypeId = 2, CompetencyRatingLevelId = 2, CompetencyLevelReqId = 2 },
                            new JobRolePositionCompetencyRating() { JobGroupId = 1, JobGroupLevelId = 3, JobPositionId = 1, CompetencyId = 3, CompetencyTypeId = 2, CompetencyRatingLevelId = 3, CompetencyLevelReqId = 3 },

                            new JobRolePositionCompetencyRating() { JobGroupId = 1, JobGroupLevelId = 2, JobPositionId = 2, CompetencyId = 1, CompetencyTypeId = 1, CompetencyRatingLevelId = 4, CompetencyLevelReqId = 4 },
                            new JobRolePositionCompetencyRating() { JobGroupId = 1, JobGroupLevelId = 2, JobPositionId = 2, CompetencyId = 2, CompetencyTypeId = 2, CompetencyRatingLevelId = 5, CompetencyLevelReqId = 5 },

                            new JobRolePositionCompetencyRating() { JobGroupId = 2, JobGroupLevelId = 3, JobPositionId = 3, CompetencyId = 2, CompetencyTypeId = 2, CompetencyRatingLevelId = 1, CompetencyLevelReqId = 1 },
                            new JobRolePositionCompetencyRating() { JobGroupId = 2, JobGroupLevelId = 3, JobPositionId = 3, CompetencyId = 3, CompetencyTypeId = 2, CompetencyRatingLevelId = 2, CompetencyLevelReqId = 2 },
                            new JobRolePositionCompetencyRating() { JobGroupId = 2, JobGroupLevelId = 3, JobPositionId = 3, CompetencyId = 4, CompetencyTypeId = 3, CompetencyRatingLevelId = 3, CompetencyLevelReqId = 3 },
                            new JobRolePositionCompetencyRating() { JobGroupId = 2, JobGroupLevelId = 3, JobPositionId = 3, CompetencyId = 6, CompetencyTypeId = 3, CompetencyRatingLevelId = 4, CompetencyLevelReqId = 4 },

                            new JobRolePositionCompetencyRating() { JobGroupId = 2, JobGroupLevelId = 2, JobPositionId = 4, CompetencyId = 2, CompetencyTypeId = 2, CompetencyRatingLevelId = 5, CompetencyLevelReqId = 5 },
                            new JobRolePositionCompetencyRating() { JobGroupId = 2, JobGroupLevelId = 2, JobPositionId = 4, CompetencyId = 3, CompetencyTypeId = 2, CompetencyRatingLevelId = 1, CompetencyLevelReqId = 1 },
                            new JobRolePositionCompetencyRating() { JobGroupId = 2, JobGroupLevelId = 2, JobPositionId = 4, CompetencyId = 4, CompetencyTypeId = 3, CompetencyRatingLevelId = 2, CompetencyLevelReqId = 2 },

                            new JobRolePositionCompetencyRating() { JobGroupId = 3, JobGroupLevelId = 3, JobPositionId = 5, CompetencyId = 1, CompetencyTypeId = 1, CompetencyRatingLevelId = 4, CompetencyLevelReqId = 4 },
                            new JobRolePositionCompetencyRating() { JobGroupId = 3, JobGroupLevelId = 3, JobPositionId = 5, CompetencyId = 2, CompetencyTypeId = 2, CompetencyRatingLevelId = 4, CompetencyLevelReqId = 4 },
                            new JobRolePositionCompetencyRating() { JobGroupId = 3, JobGroupLevelId = 3, JobPositionId = 5, CompetencyId = 4, CompetencyTypeId = 3, CompetencyRatingLevelId = 5, CompetencyLevelReqId = 5 },
                            new JobRolePositionCompetencyRating() { JobGroupId = 3, JobGroupLevelId = 3, JobPositionId = 5, CompetencyId = 6, CompetencyTypeId = 3, CompetencyRatingLevelId = 4, CompetencyLevelReqId = 4 },

                            new JobRolePositionCompetencyRating() { JobGroupId = 3, JobGroupLevelId = 3, JobPositionId = 6, CompetencyId = 1, CompetencyTypeId = 1, CompetencyRatingLevelId = 3, CompetencyLevelReqId = 3 },
                            new JobRolePositionCompetencyRating() { JobGroupId = 3, JobGroupLevelId = 3, JobPositionId = 6, CompetencyId = 2, CompetencyTypeId = 2, CompetencyRatingLevelId = 4, CompetencyLevelReqId = 4 },
                            new JobRolePositionCompetencyRating() { JobGroupId = 3, JobGroupLevelId = 3, JobPositionId = 6, CompetencyId = 6, CompetencyTypeId = 3, CompetencyRatingLevelId = 3, CompetencyLevelReqId = 3 }
                            );
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseMySQL(@"Server=localhost;port=3306;Database=CCTData;User=root;Password=root");
